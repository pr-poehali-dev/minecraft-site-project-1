...
const Index = () => {
  ...
  const dlcProducts = [
    {
      id: 1,
      title: "Minecraft Dungeons DLC",
      description: "Эпические подземелья и новые квесты",
      price: "299₽",
      originalPrice: "499₽",
      discount: "-40%",
      image: "🏰",
    ...
    },
    {
      ...
      description: "Phantom Liberty - новая история",
      price: "1299₽",
      originalPrice: "1599₽",
      discount: "-19%",
      image: "🤖",
    ...
    },
    {
      ...
      description: "Shadow of the Erdtree",
      price: "1799₽",
      originalPrice: "2199₽",
      discount: "-18%",
      image: "⚔️",
    ...
    },
    {
      ...
      description: "Финальное дополнение",
      price: "799₽",
      originalPrice: "999₽",
      discount: "-20%",
      image: "🐺",
    ...
    },
    {
      ...
      description: "Новая кампания и подкласс",
      price: "1599₽",
      originalPrice: "1999₽",
      discount: "-20%",
      image: "🚀",
    ...
    },
    {
      ...
      description: "Гоночные трассы Hot Wheels",
      price: "899₽",
      originalPrice: "1199₽",
      discount: "-25%",
      image: "🏎️",
  ...
  const getTotalPrice = () => {
    return cart.reduce(
      (total, item) => total + parseInt(item.price.replace("₽", "")),
      0,
    );
  };
        ...
        <div className="container mx-auto text-center">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6 max-w-4xl mx-auto">
            <div className="bg-gray-900/50 backdrop-blur-sm border border-gray-800 rounded-lg p-6">
              ...
              <p className="text-gray-400">Получите ключи сразу после оплаты</p>
            </div>
            <div className="bg-gray-900/50 backdrop-blur-sm border border-gray-800 rounded-lg p-6">
              <Icon
                name="Shield"
